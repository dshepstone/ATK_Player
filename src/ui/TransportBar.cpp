...
TransportBar::TransportBar(CommandRegistry* registry, QWidget* parent)
    : QWidget(parent)
    , m_registry(registry)
{
...
QToolButton* TransportBar::makeCommandButton(commands::CommandId id,
                                             const QString& glyph,
...
void TransportBar::setPlaybackState(playback::PlaybackState state)
{
